    ...
    <form action="#" id="form-enviar-busca" method="POST">
      <div class="row">
        <div class="col-sm-6 col-12 my-5">
          <input class="form-control" type="text" id="busca-candidatos" value="<?=$buscaAtual?>" placeholder="Busca por participantes">
          <button type="submit" class="btn btn-info" id="enviar-busca">Buscar</button>
          <button type="button" class="btn btn-secondary" id="limpar-busca">Limpar</button>
        </div>
      </div>
    </form>
    <div class="row">
